...
docker tag chriswilliams1977/multi-server gcr.io/williamscj-gke-demos/multi-server:latest
docker tag chriswilliams1977/multi-worker gcr.io/williamscj-gke-demos/multi-worker:latest
docker tag chriswilliams1977/multi-client gcr.io/williamscj-gke-demos/multi-client:$SHA
docker tag chriswilliams1977/multi-server gcr.io/williamscj-gke-demos/multi-server:$SHA
docker tag chriswilliams1977/multi-worker gcr.io/williamscj-gke-demos/multi-worker:$SHA
